# 1 "C:/Users/Bryan Ortiz/Desktop/Digital2/Proyecto/Codigo/Proyecto1_PICcolor.X/PICcolor.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "C:/Users/Bryan Ortiz/Desktop/Digital2/Proyecto/Codigo/Proyecto1_PICcolor.X/PICcolor.c" 2
# 11 "C:/Users/Bryan Ortiz/Desktop/Digital2/Proyecto/Codigo/Proyecto1_PICcolor.X/PICcolor.c"
...
# 32 "C:/Users/Bryan Ortiz/Desktop/Digital2/Proyecto/Codigo/Proyecto1_PICcolor.X/PICcolor.c" 2
...
# 33 "C:/Users/Bryan Ortiz/Desktop/Digital2/Proyecto/Codigo/Proyecto1_PICcolor.X/PICcolor.c" 2

# 1 "C:/Users/Bryan Ortiz/Desktop/Digital2/Proyecto/Codigo/Proyecto1_PICcolor.X/I2C.h" 1
# 18 "C:/Users/Bryan Ortiz/Desktop/Digital2/Proyecto/Codigo/Proyecto1_PICcolor.X/I2C.h"
...
# 18 "C:/Users/Bryan Ortiz/Desktop/Digital2/Proyecto/Codigo/Proyecto1_PICcolor.X/I2C.h" 2


# 1 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\include\\c90\\stdint.h" 1 3
# 20 "C:/Users/Bryan Ortiz/Desktop/Digital2/Proyecto/Codigo/Proyecto1_PICcolor.X/I2C.h" 2
# 29 "C:/Users/Bryan Ortiz/Desktop/Digital2/Proyecto/Codigo/Proyecto1_PICcolor.X/I2C.h"
...
# 34 "C:/Users/Bryan Ortiz/Desktop/Digital2/Proyecto/Codigo/Proyecto1_PICcolor.X/PICcolor.c" 2

# 1 "C:/Users/Bryan Ortiz/Desktop/Digital2/Proyecto/Codigo/Proyecto1_PICcolor.X/LCD8B.h" 1
# 31 "C:/Users/Bryan Ortiz/Desktop/Digital2/Proyecto/Codigo/Proyecto1_PICcolor.X/LCD8B.h"
...
# 35 "C:/Users/Bryan Ortiz/Desktop/Digital2/Proyecto/Codigo/Proyecto1_PICcolor.X/PICcolor.c" 2
# 52 "C:/Users/Bryan Ortiz/Desktop/Digital2/Proyecto/Codigo/Proyecto1_PICcolor.X/PICcolor.c"
uint8_t adc_val;
uint8_t REDL=0, REDH=0, GREENL=0, GREENH=0, BLUEL=0, BLUEH=0;

uint16_t REDlong=0, GREENlong=0, BLUElong=0;
uint8_t RED=0, GREEN=0, BLUE=0;
char CharR[3],CharG[3],CharB[3];
uint16_t peso;
uint8_t distance;
char tempChar[4];

unsigned int S1_periodo = 10;
...
void main(void){
    ...
    while(1){
        ...
        I2C_Master_Start();
        I2C_Master_Write(0x52 | 0x00);
        I2C_Master_Write( 0x80 |0x20 | 0x14);
        I2C_Master_RepeatedStart();
        I2C_Master_Write(0x52 | 0x01);
        REDL = I2C_Master_Read(1);
        REDH = I2C_Master_Read(1);
        REDL = I2C_Master_Read(1);
        REDH = I2C_Master_Read(0);
        I2C_Master_Stop();
        ...
        I2C_Master_RepeatedStart();
        I2C_Master_Write(0x52 | 0x01);
        GREENL = I2C_Master_Read(1);
        GREENH = I2C_Master_Read(0);
        I2C_Master_Stop();
        ...
        I2C_Master_RepeatedStart();
        I2C_Master_Write(0x52 | 0x01);
        BLUEL = I2C_Master_Read(1);
        BLUEH = I2C_Master_Read(0);



        CharR[0] = REDH / 100 + 48;
        CharR[1] = (REDH / 10) % 10 + 48;
        CharR[2] = REDH % 10 + 48;

        CharG[0] = GREENH / 100 + 48;
        CharG[1] = (GREENH / 10) % 10 + 48;
        CharG[2] = GREENH % 10 + 48;

        CharB[0] = BLUEH / 100 + 48;
        CharB[1] = (BLUEH / 10) % 10 + 48;
        CharB[2] = BLUEH % 10 + 48;
# 218 "C:/Users/Bryan Ortiz/Desktop/Digital2/Proyecto/Codigo/Proyecto1_PICcolor.X/PICcolor.c"
        Lcd_Set_Cursor(1,1);
        ...
        tempChar[0] = peso/1000 + 48;
        tempChar[1] = peso%1000/100 + 48;
        tempChar[2] = peso%100/10 + 48;
        tempChar[3] = peso%10 + 48;
        Lcd_Set_Cursor(2,0);
        Lcd_Write_String("P:");
        ...
        tempChar[0] = distance/1000 + 48;
        tempChar[1] = distance%1000/100 + 48;
        tempChar[2] = distance%100/10 + 48;
        tempChar[3] = (distance)%10 + 48;
        Lcd_Set_Cursor(2,9);
        Lcd_Write_String("D:");
        Lcd_Write_Char(tempChar[0]);
        Lcd_Write_Char(tempChar[1]);
